...
using System;
 https://blog.csdn.net/SnoopyNa2Co3/article/details/84648885?spm=1001.2101.3001.6650.3&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7Edefault-3.no_search_link&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7Edefault-3.no_search_link
class CreateRagdoll : ScriptableWizard
{
    ...
    void BuildBodies()
    {
        foreach (BoneInfo bone in bones)
        {
            Rigidbody ri = bone.anchor.gameObject.AddComponent<Rigidbody>();
