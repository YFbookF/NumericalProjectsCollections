...
$$
\begin{bmatrix} e_{10} & e_{11} & e_{12}\\e_{10} & e_{11} & e_{12}\\e_{10} & e_{11} & e_{12}\\1 & 1 & 1\end{bmatrix}\begin{bmatrix} x_0 \\ x_1 \\ x_2\end{bmatrix} = \begin{bmatrix} g_0 \\ g_1 \\ g_2\end{bmatrix}
$$
...
各种VortexSheet,Fliament,turbulencepart
