...
void MeshMananger::RenderCube()
{
	...
	if (cubeVAO == 0)
	{
		...
		float vertices[] = {
			...
			-1.0f, -1.0f, -1.0f + z_offset,  0.0f, -1.0f,  0.0f, 0.0f, 1.0f, // top-right
			// top face
			-1.0f,  1.0f, -1.0f + z_offset,  0.0f,  1.0f,  0.0f, 0.0f, 1.0f, // top-left
			 1.0f,  1.0f , 1.0f + z_offset,  0.0f,  1.0f,  0.0f, 1.0f, 0.0f, // bottom-right
			 1.0f,  1.0f, -1.0f + z_offset,  0.0f,  1.0f,  0.0f, 1.0f, 1.0f, // top-right     
			 1.0f,  1.0f,  1.0f + z_offset,  0.0f,  1.0f,  0.0f, 1.0f, 0.0f, // bottom-right
			-1.0f,  1.0f, -1.0f + z_offset,  0.0f,  1.0f,  0.0f, 0.0f, 1.0f, // top-left
			-1.0f,  1.0f,  1.0f + z_offset, 0.0f,  1.0f,  0.0f, 0.0f, 0.0f  // bottom-left        
		};
